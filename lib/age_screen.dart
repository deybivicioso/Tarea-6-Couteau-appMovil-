  ...
  void _determineAge() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        if (age <= 18) {
          _message = 'Joven';
          _image = 'assets/nino.jpg'; // Imagen relacionada
        } else if (age <= 65) {
          _message = 'Adulto';
          _image = 'assets/senor.jpg';
        } else {
          _message = 'Anciano';
          _image = 'assets/vieto.jpg';
        }
        _loading = false;
      });
    } else {
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          const Color.fromARGB(255, 202, 202, 202), // Azul medio
                      padding:
